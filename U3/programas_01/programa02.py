...
def saludar(nombre, apellido1, apellido2, curso = "2DAW"):
    print(f"Buenas {nombre} {apellido1} {apellido2} del curso {curso}")

saludar('Miguel', 'Angel', 'Duran', 'ASIR')
saludar('Miguel', 'Angel', 'Duran', curso = 'ASIR')
saludar('Miguel Angel', 'Duran', 'Soto')